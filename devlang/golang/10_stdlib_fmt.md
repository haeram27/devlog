...
// Expand a string containing environment variables in the form of
$var or ${var}
...
// Environ returns a slice of string containing all the environment
variables in the form of key=value.
...
[fmt.Printf formatting tutorial and cheat sheet · YourBasic
Go](https://yourbasic.org/golang/fmt-printf-reference-cheat-sheet/)
