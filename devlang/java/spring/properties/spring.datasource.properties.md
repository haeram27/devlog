...
@EnableConfigurationProperties({
    RdbDataSourceConfig.AdminDbProperties.class,
    RdbDataSourceConfig.ShareDbProperties.class
})
public class RdbDataSourceConfig {

    @Primary
    @Bean(name = "firstDataSource")
    public DataSource firstDataSource(AdminDbProperties properties) {
    ...
    public DataSource secondDataSource(ShareDbProperties properties) {
        return createDataSource(properties);
    }
    ...
    public record ShareDbProperties(
        List<String> entityPackages,
        String url,
        String username,
        String password,
...
import com.ahnlab.one.platform.deployment.server.SpringApplication;
