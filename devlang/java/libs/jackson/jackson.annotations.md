...
* https://fasterxml.github.io/jackson-databind/javadoc/2.13/com/fasterxml/jackson/databind/PropertyNamingStrategies.html#SNAKE_CASE@JsonNaming(PropertyNamingStrategies.LowerCamelCaseStrategy.class)
...
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@Data
public class NodeHW implements Serializable {
