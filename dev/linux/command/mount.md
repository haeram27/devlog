...
- bind mount
  ...
  - 단, 원본 디렉토리의 하위 서브 디렉토리에 마운트 포인트(submount)가 있다면 submount 디렉토리는 빈 상태로 마운트된다.  

- recursive bind mount
  - --rbind 옵션 사용
  - 바인드 마운트와 동일하나 원본 디렉토리의 하위 서브 디렉토리에 마운트 포인트(submount)가 있다면 submount 포인트도 함께 마운트한다.
